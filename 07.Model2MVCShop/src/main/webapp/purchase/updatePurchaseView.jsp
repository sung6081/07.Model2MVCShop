...
<form name="updatePurchase" method="post"	action="/purchase/updatePurchase.do?tranNo=${purchase.tranNo }<%-- purchaseVO.getTranNo() --%>">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">${purchase.buyer.userId }<%-- purchaseVO.getBuyer().getUserId() --%></td>
