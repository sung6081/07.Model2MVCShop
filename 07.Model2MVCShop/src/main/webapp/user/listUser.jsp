	...
	<tr>
		<td align="right">
			<select name="searchCondition" class="ct_input_g" style="width:80px">
				...
				<option value="0" ${search.searchCondition eq "1" ? "selected" : "" }>회원ID</option>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<%--
		for(int i=0; i<list.size(); i++) {
			User vo = list.get(i);
	--%>
	<f:set var="i" value="${search.pageSize }" />
	...
	<tr class="ct_list_pop">
		...
		<td></td>
		<td align="left">
			<a href="/user/getUser.do?userId=${vo.userId }">${vo.userId }</a>
		</td>
		<td></td>
		<td align="left">${vo.userName }<%-- vo.getUserName() --%></td>
		<td></td>
		<td align="left">${vo.email }<%-- vo.getEmail() --%>	</td>		
	</tr>
	<tr>
