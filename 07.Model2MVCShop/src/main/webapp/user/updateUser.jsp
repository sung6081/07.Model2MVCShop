...
function fncUpdateUser() {
	...
	document.detailForm.action='/user/updateUser.do';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">                                     <%--<%=user.getUserName() %> --%>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">                         <%--<%=user.getAddr() %> --%>
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="phone1" class="ct_input_g" style="width:50px; height:20px" 
				...
				--%>	
				<f:if test="${user.phone ne null }">
				<option value="010"  ${user.phone1 eq "010" ? "selected" : "" } >010</option>
				<option value="011"  ${user.phone1 eq "011" ? "selected" : "" } >011</option>
				<option value="016"  ${user.phone1 eq "016" ? "selected" : "" } >016</option>
				<option value="018"  ${user.phone1 eq "018" ? "selected" : "" } >018</option>
				<option value="019"  ${user.phone1 eq "019" ? "selected" : "" } >019</option>
				</f:if>
			
				<f:if test="${user.phone eq null }">
			...
			</select>											<%-- <%= phone2.equals("")? "" : phone2 %> --%>
			<f:choose>
			<f:when test="${user.phone ne null }">
			<input 	type="text" name="phone2" value="${user.phone2 eq '' ? '' : user.phone2 }" 
							class="ct_input_g" style="width:100px; height:19px"  maxLength="9" >
			- 														<%-- <%= phone3.equals("")? "" : phone3 %> --%>
			<input 	type="text" name="phone3" value="${user.phone3 eq '' ? '' : user.phone3 }"  
							class="ct_input_g"  style="width:100px; height:19px"  maxLength="9" >
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">									<%-- <%=user.getEmail() %> --%>
